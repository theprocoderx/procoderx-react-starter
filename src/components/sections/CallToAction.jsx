    ...
    <section aria-labelledby='cta-heading' className='bg-(--bg) py-24'>
      <div className='mx-auto max-w-5xl px-6'>
        <div className='overflow-hidden rounded-3xl border border-(--border) bg-(--surface) p-10 text-center shadow-sm sm:p-16'>
          {/* Header */}
          <header>
            <p className='rounded-full bg-(--primary) px-4 py-2 text-sm font-semibold text-(--primary-text)'>
              Open Source
            </p>
          ...
          <nav aria-label='Call to action' className='mt-10 flex flex-col justify-center gap-4 sm:flex-row'>
            <a
              ...
              className='rounded-xl bg-(--primary) px-6 py-3 font-semibold text-(--primary-text) transition-all duration-300 hover:-translate-y-1 hover:opacity-90 focus-visible:ring-2 focus-visible:ring-(--focus-ring) focus-visible:ring-offset-2 focus-visible:outline-none'
            >
            ...
            <Link
              to='/'
              className='rounded-xl border border-(--border) bg-(--bg) px-6 py-3 font-semibold text-(--text) transition-all duration-300 hover:bg-(--surface-hover) focus-visible:ring-2 focus-visible:ring-(--brand) focus-visible:ring-offset-2 focus-visible:outline-none'
            >
              Start Building
            </Link>
          </nav>
