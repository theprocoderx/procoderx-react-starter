...
Every feature should contribute toward making production application development faster, more consistent, and easier to maintain.
...
Quick fixes should be avoided unless explicitly required.
...
The starter kit should minimize repetitive work by providing:
